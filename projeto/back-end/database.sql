-- ═══════════════════════════════════════════════════════════════
-- Script SQL – Criação do banco de dados BoostPro
-- Banco: MySQL 8.x
-- Execute este script antes de iniciar a aplicação Flask.
-- ═══════════════════════════════════════════════════════════════
...
-- ─────────────────────────────────────────────
-- Tabela: usuarios
-- Armazena dados de clientes e administradores.
-- A senha é salva como hash (gerado pelo Werkzeug).
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- Tabela: servicos
-- Armazena os serviços de boosting disponíveis.
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- Dados de exemplo: serviços iniciais
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- Administrador padrão (criado pelo app.py)
-- Caso prefira criar manualmente via SQL:
-- Senha: admin123 (hash abaixo é apenas exemplo – use o gerado pelo Flask)
-- ─────────────────────────────────────────────
-- INSERT INTO usuarios (nome, email, senha, tipo_usuario) VALUES
-- ('Administrador', 'admin@boosting.com', '<HASH_GERADO_PELO_FLASK>', 'administrador');
